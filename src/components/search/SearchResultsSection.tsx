      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-8">
            ...
            <p className="text-gray-500 mb-2">No parents found for "{searchTerm}"</p>
            <p className="text-sm text-gray-400">
              Please check for typos or try a different search term
            </p>
          </div>
        </CardContent>
      </Card>
        ...
        <div className="space-y-3">
          {searchResults.map((profile, index) => (
            <div key={profile.id} className="relative">
              ...
              />
              {profile.similarity_score && profile.similarity_score > 0.8 && (
